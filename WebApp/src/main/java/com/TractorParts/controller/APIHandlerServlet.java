...
import com.TractorParts.utils.JSON;
import com.TractorParts.utils.JSONResponses;
...
public class APIHandlerServlet extends HttpServlet{
    ...
    static {
        ...
        map.put("goods", GoodsServlet.getInstance());
        map.put("group", GroupServlet.getInstance());
